<?php
	...
	$sth = mysqli_prepare($con,"SELECT DISTINCT name,icon,version,type,description,id,data,date,titleid,screenshots,long_description,downloads FROM switchdb WHERE author=? OR author LIKE ? OR author LIKE ? ORDER BY date DESC");
