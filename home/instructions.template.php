	...
	<div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-offset-1 col-lg-10">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				SwitchDB is an opensource project started on January 2018 which aims to build a fully responsive website to handle a generic database with an "appstore-like" look.<br>
				To achieve these goals, SwitchDB currently uses AngularJS framework, a MySQL database and some PHP scripts which handle the backend connection between the frontend website and the real database.<br>
				If you want to help the development or report a bug, please refer to our <a href="https://github.com/Rinnegatamante/SwitchDB">GitHub page</a>.<br><br>
				SwitchDB currently provides users support with different privileges depending on how much trusted the user is. There are three different trustzones for the submitted contents and, depending on which level the applications are, they can be downloaded from normal users.<br>
			...
			<div class="panel-body">
				...
				Standard <b>Users</b> can submit only untrusted contents. These contents will be approved or discarded by a moderator before being shown to SwitchDB userbase.<br>&nbsp;
